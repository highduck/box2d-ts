...
function DumpCircleShape(shape: b2CircleShape, log: (format: string, ...args: any[]) => void): void {
...
function DumpPolygonShape(shape: b2PolygonShape, log: (format: string, ...args: any[]) => void): void {
