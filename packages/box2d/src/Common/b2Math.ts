...
import { b2_pi, b2_epsilon } from "./b2Settings.js";
...
export function b2MinInt(a: number, b: number): number { return a < b ? a : b }
export function b2MaxInt(a: number, b: number): number { return a > b ? a : b }
...
export class b2Transform {
  ...
  public static MulXV<TOut extends XY>(T: b2Transform, v: XY, out: TOut): TOut {
  ...
  public static MulTXV<TOut extends XY>(T: b2Transform, v: XY, out: TOut): TOut {
