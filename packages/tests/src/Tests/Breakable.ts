...
export class Breakable extends Test {
  ...
  public Break() {
    ...
    /*b2Vec2*/
    const velocity1 = b2Vec2.AddVCrossSV(this.m_velocity, this.m_angularVelocity, b2Vec2.SubVV(center1, center, b2Vec2.s_t0), new b2Vec2());
    /*b2Vec2*/
    const velocity2 = b2Vec2.AddVCrossSV(this.m_velocity, this.m_angularVelocity, b2Vec2.SubVV(center2, center, b2Vec2.s_t0), new b2Vec2());
