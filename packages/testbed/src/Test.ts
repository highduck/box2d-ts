...
export class Test extends b2ContactListener {
    ...
    public readonly m_points: ContactPoint[] = b2MakeArray(Test.k_maxContactPoints, (i) => new ContactPoint());
    ...
    private static PreSolve_s_state1: b2PointState[] = [/*b2_maxManifoldPoints*/];
    private static PreSolve_s_state2: b2PointState[] = [/*b2_maxManifoldPoints*/];
