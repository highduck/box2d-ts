...
export class ParticleParameter {
    ...
    public static readonly k_particleTypes: ParticleParameterValue[] = [
        ...
        new ParticleParameterValue(b2ParticleFlag.b2_barrierParticle | b2ParticleFlag.b2_wallParticle, ParticleParameter.k_DefaultOptions, "barrier"),
        new ParticleParameterValue(b2ParticleFlag.b2_staticPressureParticle, ParticleParameter.k_DefaultOptions, "static pressure"),
        new ParticleParameterValue(b2ParticleFlag.b2_waterParticle, ParticleParameter.k_DefaultOptions | ParticleParameterOptions.OptionDrawAABBs, "water (bounding boxes)"),
    ];
